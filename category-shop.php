...
$products = db_select('products', "category_id = $category_id", 'ORDER BY products_id DESC');
            ...
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                  ...
                  <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo htmlspecialchars($category_name); ?></li>
                </ol>
              </nav>
            </div>
            <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
              <h1 class="h3 text-light mb-0"><?php echo htmlspecialchars($category_name); ?></h1>
            </div>
          </div>
        </div>
      </div>
...
<div class="row pt-3 mx-n2">
    <?php 
        foreach ($products as $key => $pro) {
          $image = get_product_image($pro['products_id'], $conn);
          echo product_item_ui1($pro, $image);
      }
    ?>
</div>
